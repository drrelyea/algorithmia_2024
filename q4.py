# %%
with open("everybody_codes_e2024_q04_p1.txt") as input_file:
...
# %%
with open("everybody_codes_e2024_q04_p2.txt") as input_file:
    inpstring = input_file.readlines()
...
# %%
with open("everybody_codes_e2024_q04_p3.txt") as input_file:
    inpstring = input_file.readlines()
